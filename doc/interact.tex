...
performs menu item 1 of the main $p$-Quotient menu.
...
menu item 6 of the main $p$-Quotient menu.
...
menu item 7 of the main $p$-Quotient menu.
...
for the <i>th or default interactive {\ANUPQ} process, directs  the  `pq'
binary  to  echelonise  the  relation   collected   by   `PqCollect'   or
`PqCommutator'. A call to `PqCollect' (see~"PqCollect") or `PqCommutator'
