...
understands  to  a  form  that  {\GAP}   understands,   `PqParseWord'   a
syntax-checker for words in pc generators, `PqExample' which executes  or
displays examples for the  {\ANUPQ}  package  or  displays  an  index  of
examples, `AllPqExamples' a command for listing available  examples,  and
`GrepPqExample' an example search tool; and
