...
respectively, where <G> is one of the following:

\beginlist%unordered

\item{--} a pc group returned by `Pq' (see~"Pq");

\item{--}  the  image  (pc  group)  of  the  epimorphism  returned  by  a
`PqEpimorphism' call (see~"PqEpimorphism");
...
`PqDescendants' (see~"PqDescendants"); or

\item{--}    the    pc     group     returned     by     `PqCurrentGroup'
(see~"PqCurrentGroup").
