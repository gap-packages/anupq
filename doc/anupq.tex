...
record components (see~"ref:function call with options").  Section~"Hints
and Warnings regarding the use of Options" gives some important hints and
warnings regarding option usage; if you haven't read this section, please
