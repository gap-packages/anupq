...
program, thus allowing the user to interact with the `pq' program like  one
can when one uses the `pq' program as a  stand-alone  (see~`guide.dvi'  in
...
*Note:* 
For those  familiar  with  the  `pq'  program,  `PqPGRestoreGroupFromFile'
