...
is determined by applying `PrimePGroup'  (see~"ref:PrimePGroup")  to  the
value of `pQuotient').
...
except that their return value is an *epimorphism to* an fp  group,  i.e.
one should interpret the phrase ``returns an fp group'' as  ``returns  an
epimorphism to an fp group'' etc.
