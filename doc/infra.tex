...
\item{$\bullet$} 
in Section~"Utility functions" we define a function `PqLeftNormComm'  for
computing left norm  commutators  in  {\GAP}  and  `PqGAPRelators'  which
converts strings representing  relators  in  a  format  the  `pq'  binary
understands to a form that {\GAP} understands.
