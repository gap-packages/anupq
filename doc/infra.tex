...
enables the display of timing and memory usage data from the `pq' program.
...
to discover something about the current state known to the `pq'  program).
In some cases, the `pq' program produces a lot of output despite the  fact
