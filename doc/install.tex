...
that version 1.2 of the {\ANUPQ} package requires at least {\GAP} 4.3fix4
...
\begintt
Made dir: /tmp/testPq
Testing installation of ANUPQ Package (version 1.2)
...
for version 1.2 of the ANUPQ package and that GAP is finding
...
Checking GAP ...
 ...
 Starting GAP to determine version and package availability ...
  ...
  GAP found ANUPQ package (1.2) ... good.
