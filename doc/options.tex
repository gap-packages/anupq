...
[ "AllDescendants", "BasicAlgorithm", "Bounds", "CapableDescendants", 
  "ClassBound", "CustomiseOutput", "Exponent", "GroupName", "Metabelian", 
  "OrderBound", "OutputLevel", "PcgsAutomorphisms", "PqWorkspace", 
  "Prime", "QueueFactor", "RankInitialSegmentSubgroups", "RedoPcp", 
  "Relators", "SetupFile", "SpaceEfficient", "StandardPresentationFile", 
  "StepSize", "SubList" ]
\endexample
...
the  maximum  possible  for  the  `pq'  binary)  is  taken,  except   for
...
stored by the `pq' binary be  scrapped  and  clears  the  current  values
...
of <G>, be computed and passed to the `pq'  binary.  This  increases  the
...
\>`OrbitsSummary := <list>'{option OrbitsSummary}%
@{option `OrbitsSummary'|indexit}&
Specifies that a summary of orbit information be printed.

\>`OrbitsListing := <list>'{option OrbitsListing}%
@{option `OrbitsListing'|indexit}&
Specifies that a complete listing of orbit information be  printed.  This
option is independent of `OrbitsSummary' (it's possible to  have  both  a
summary and a complete listing of orbit information).
