...
[ "AllDescendants", "BasicAlgorithm", "Bounds", "CapableDescendants", 
  ...
  "OrderBound", "OutputLevel", "PcgsAutomorphisms", "PqWorkspace", "Prime", 
  "QueueFactor", "RankInitialSegmentSubgroups", "Relators", "SetupFile", 
  "SpaceEfficient", "StandardPresentationFile", "StepSize", "SubList" ]
\endexample
...
instead of than the relators of the group <F>; <rels> should be a list of
...
permutation  group  output  should  contain:  the  degree,  the  extended
...
output should contain: a summary,  and  a  complete  listing  of  orbits,
respectively. (It's possible to have *both*  a  summary  and  a  complete
listing.)
