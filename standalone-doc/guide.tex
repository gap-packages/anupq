...
\item[\texttt{-w} {\it file}]\ \\
      Group descriptions are written in {\sc Magma} or {\sf GAP} 
      format to {\em file}. One of \texttt{-m} or \texttt{-g}
...
25. Write presentation to file in GAP/Magma format
...
{\sc Magma} or {\sf GAP}, which computes stabilisers of particular 
...
is computed by {\sc Magma}/{\sf GAP} and handed back to pq.  The soluble machinery 
