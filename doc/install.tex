...
that since version 1.2, the {\ANUPQ} package requires at least {\GAP} 4.3fix4
and updates to the {\AutPGrp} package provided at the time fix4 of {\GAP}
4.3 was released (the `testPq' script checks for these). The  output  you
see should be something like the following:

\begintt
Made dir: /tmp/testPq
Testing installation of ANUPQ Package (version 1.3)
...
for version 1.3 of the ANUPQ package and that GAP is finding
...
Checking GAP ...
 ...
 Starting GAP to determine version and package availability ...
  ...
  GAP found ANUPQ package (1.3) ... good.
  GAP has AutPGrp package installed ...
   checking AutPGrp package includes recent updates ... yes.
 GAP is OK.
