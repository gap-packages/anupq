...
and return the number of orbits. Here the  options  <options>  recognised
are   `PcgsAutomorphisms',    `SpaceEfficient',    `OrbitsSummary'    and
`OrbitsListing' (see Chapter~"ANUPQ Options" for details).
